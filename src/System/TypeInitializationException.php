...
namespace System {
     ...
     */
    class TypeInitializationException extends \Exception {
       
        /**
         * Initializes a new instance of the System.TypeInitializationException class with a specified error message and a reference to the inner exception that is the cause of this exception.
         * @access public
