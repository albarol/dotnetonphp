...
namespace System {
     ...
     */
    class MissingMemberException extends \Exception {
       
        /**
         * Initializes a new instance of the System.MissingMemberException class with a specified error message and a reference to the inner exception that is the cause of this exception.
         * @access public
