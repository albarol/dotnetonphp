...
require_once(dirname(__FILE__).'/xpath/IXPathNavigable.php');
...
abstract class XmlNode implements ICloneable, IEnumerable, IXPathNavigable {
     ...
     * @access public
     * @return XmlAttributeCollection An XmlAttributeCollection containing the attributes of the node. If the node is of type XmlNodeType.Element, the attributes of the node are returned. Otherwise, this property returns null.
     */
     ...
     * @param XmlNode $newChild The node to add. All the contents of the node to be added are moved into the specified location.
     * @return void
     */
     ...
     * @access public
     * @return XmlNodeList An System.Xml.XmlNodeList that contains all the child nodes of the node. If there are no child nodes, this property returns an empty System.Xml.XmlNodeList.
     */
     ...
     * @access public
     * @return XmlNode The first child of the node. If there is no such node, null is returned.
     */
     ...
     * @return XmlElement The first System.Xml.XmlElement that matches the specified name.
     */
     ...
     * @access public
     * @throws InvalidOperationException|XmlException
     * @param $value sets the markup representing only the child nodes of this node.
     * @return string The markup of the child nodes of this node. Note:InnerXml does not return default attributes.
     */
    public function innerXml($value) {
     ...
     * @access public
     * @throws InvalidOperationException|ArgumentException
     * @param XmlNode $newChild The XmlNode to insert.
     * @param XmlNode $refChild The XmlNode that is the reference node. The newNode is placed after the refNode.
     * @return XmlNode The node being inserted.
     */
     ...
     * @throws InvalidOperationException|ArgumentException
     * @param XmlNode $newChild The XmlNode to insert.
     * @param XmlNode $refChild The XmlNode that is the reference node.  The newChild is placed before this node.
     * @return XmlNode The node being inserted.
     */
     ...
     * @access public
     * @return XmlNode The last child of the node. If there is no such node, null is returned.
     */
     ...
     * @access public
     * @return XmlNode The next XmlNode. If there is no next node, null is returned.
     */
     ...
     * @access public
     * @return XmlDocument The System.Xml.XmlDocument to which this node belongs.  If the node is an System.Xml.XmlDocument (NodeType equals XmlNodeType.Document), this property returns null.
     */
     ...
     * @access public
     * @throws ArgumentException|XmlException
     ...
     * @access public
     * @return IXmlSchemaInfo An System.Xml.Schema.IXmlSchemaInfo object containing the post schema validation infoset of this node
     */
     ...
     * @param XmlNode $oldChild The node being removed. 
     * @return XmlNode The node removed.
     */
     ...
     * @access public
     * @throws InvalidOperationException|ArgumentException
     * @param XmlNode $newChild The new node to put in the child list.
     * @param XmlNode $oldChild The node being replaced in the list.
     * @return XmlNode The node replaced.
     */
     ...
     * @param XmlNamespaceManager $nsmgr An System.Xml.XmlNamespaceManager to use for resolving namespaces for prefixes in the XPath expression.
     * @return XmlNodeList An System.Xml.XmlNodeList containing a collection of nodes matching the XPath query. The XmlNodeList should not be expected to be connected "live" to the XML document. That is, changes that appear in the XML document may not appear in the XmlNodeList, and vice versa.
     */
     ...
     * @return void The value returned depends on the System.Xml.XmlNode.NodeType of the node:  
     */
