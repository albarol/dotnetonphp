...
namespace System\IO {
    ...
    class FileAttributes extends Enum {
        ...
        public static function archive() {
            return new FileAccess("ARCHIVE", 32);
        }
        ...
        public static function compressed() {
            return new FileAccess("COMPRESSED", 2048);
        }
        ...
        public static function device() {
            return new FileAccess("DEVICE", 64);
        }
        ...
        public static function directory() {
            return new FileAccess("DIRECTORY", 16);
        }
        ...
        public static function encrypted() {
            return new FileAccess("ENCRYPTED", 16384);
        }
        ...
        public static function hidden() {
            return new FileAccess("HIDDEN", 2);
        }
        ...
        public static function normal() {
            return new FileAccess("NORMAL", 128);
        }
        ...
        public static function notContentIndexed() {
            return new FileAccess("NOT_CONTENT_INDEXED", 8192);
        }
        ...
        public static function offline() {
            return new FileAccess("OFFLINE", 4096);
        }
        ...
        public static function readOnly() {
            return new FileAccess("READ_ONLY", 1);
        }
        ...
        public static function reparsePoint() {
            return new FileAccess("REPARSE_POINT", 1024);
        }
        ...
        public static function sparseFile() {
            return new FileAccess("SPARSE_FILE", 512);
        }
        ...
        public static function system() {
            return new FileAccess("SYSTEM", 4);
        }
        ...
        public static function temporary() {
            return new FileAccess("TEMPORARY", 256);
        }
    }
}