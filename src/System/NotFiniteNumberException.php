...
namespace System {
     ...
     */
    class NotFiniteNumberException extends \Exception {
       
        /**
         * Initializes a new instance of the System.NotFiniteNumberException class with a specified error message and a reference to the inner exception that is the cause of this exception.
         * @access public
