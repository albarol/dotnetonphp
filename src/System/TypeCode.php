...
namespace System { 
    ...
    class TypeCode extends Enum {
         ...
         * @access public
         * @static
         * @return TypeCode Boolean TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode DateAndTime TypeCode
         */
        public static function dateAndTime() {
            return new TypeCode("DateAndTime", 16);
        }
         ...
         * @access public
         * @static
         * @return TypeCode DbNull TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode Int16 TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode Int32 TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode Int64 TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode Object TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode SByte TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode Single TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode UInt16 TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode UInt32 TypeCode
         */
         ...
         * @access public
         * @static
         * @return TypeCode UInt64 TypeCode
         */
